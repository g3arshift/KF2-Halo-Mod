...
simulated function PlayWeaponEquip( float ModifiedEquipTime )
{
	...
	if(M392_UI == none)
	{
		...
		VertRangefinderFlavor.MakeFlavorIcon(VertRangefinderCanvas, 781, 769, 1063, 1076, 1238, 1037, 1078, 800, 1652, 1309, 1517, 798, 2357, 798, 0.40932, 0.5233, 0.45076, 0.44329, 0.61138, 0.45076, 0.45076, IconColor);//0.20466, 0.26165, 0.22538, 0.44329/*0.22538*/, 0.30569, 0.22538, 0.22538,IconColor);
		LeftRangefinderFlavor.MakeFlavorIcon(LeftRangefinderCanvas, 667, 720, 925, 1024, 1090, 960, 930, 720, 1463, 1197, 1368, 720, 2209, 720, 0.4, 0.495, 0.48832, 0.48833, 0.63832, 0.48832, 0.48832, IconColor);//0.2, 0.2475, 0.24416, 0.48833/*0.24416*/, 0.31916, 0.24416, 0.24416, IconColor);
