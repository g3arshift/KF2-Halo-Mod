package scaleform.clik.motion
{
   ...
   public class Tween
   {
      ...
      {
         ticker.addEventListener(Event.ENTER_FRAME,scaleform.clik.motion.Tween.tick,false,0,true);
      }
      ...
      protected static function tick(param1:Event) : void
      {
         ...
         lastTime = _loc2_;
         var _loc4_:scaleform.clik.motion.Tween = firstTween;
         while(_loc4_)
         {
      ...
      protected static function removeTween(param1:scaleform.clik.motion.Tween) : void
      {
         if(param1.prev)
         {
