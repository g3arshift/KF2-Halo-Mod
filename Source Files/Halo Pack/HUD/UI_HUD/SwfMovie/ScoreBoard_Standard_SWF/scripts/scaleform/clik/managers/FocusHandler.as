package scaleform.clik.managers
{
   ...
   public class FocusHandler
   {
      ...
      public static function getInstance() : scaleform.clik.managers.FocusHandler
      {
         if(instance == null)
         {
            instance = new scaleform.clik.managers.FocusHandler();
         }
         return instance;
      }
      ...
      public static function init(param1:Stage, param2:UIComponent) : void
      {
         ...
         var _loc3_:scaleform.clik.managers.FocusHandler = scaleform.clik.managers.FocusHandler.getInstance();
         _loc3_.stage = param1;
      ...
      public function setFocus(param1:DisplayObject, param2:uint = 0, param3:Boolean = false) : void
      {
         ...
         var _loc8_:DisplayObject = this.currentFocusLookup.getValue(param2) as DisplayObject;
         if(_loc8_ != param1)
         {
      ...
      protected function handleInput(param1:InputEvent) : void
      {
         ...
         var _loc4_:InteractiveObject = this.currentFocusLookup.getValue(_loc3_) as InteractiveObject;
         if(_loc4_ == null)
         {
            _loc4_ = this._stage;
         }
