package com.greensock
{
   ...
   public class TweenLite extends Animation
   {
      ...
      protected var _startAt:com.greensock.TweenLite;
      ...
      public static function to(param1:Object, param2:Number, param3:Object) : com.greensock.TweenLite
      {
         return new com.greensock.TweenLite(param1,param2,param3);
      }
      
      public static function from(param1:Object, param2:Number, param3:Object) : com.greensock.TweenLite
      {
      ...
      public static function fromTo(param1:Object, param2:Number, param3:Object, param4:Object) : com.greensock.TweenLite
      {
         ...
         return new com.greensock.TweenLite(param1,param2,param4);
      }
      ...
      public static function delayedCall(param1:Number, param2:Function, param3:Array = null, param4:Boolean = false) : com.greensock.TweenLite
      {
         return new com.greensock.TweenLite(param2,0,{
            "delay":param1,
            "onComplete":param2,
      ...
      public static function set(param1:Object, param2:Object) : com.greensock.TweenLite
      {
         return new com.greensock.TweenLite(param1,0,param2);
      }
      ...
      public static function killTweensOf(param1:*, param2:* = false, param3:Object = null) : void
      {
         ...
         var _loc4_:Array = com.greensock.TweenLite.getTweensOf(param1,param2);
      ...
      public static function getTweensOf(param1:*, param2:Boolean = false) : Array
      {
         ...
         var _loc5_:int = 0;
         var _loc6_:com.greensock.TweenLite = null;
      ...
      protected static function _register(param1:Object, param2:com.greensock.TweenLite = null, param3:Boolean = false) : Array
      {
         var _loc5_:int = 0;
      ...
      protected static function _applyOverwrite(param1:Object, param2:com.greensock.TweenLite, param3:Object, param4:int, param5:Array) : Boolean
      {
         var _loc6_:int = 0;
         var _loc7_:Boolean = false;
         var _loc8_:com.greensock.TweenLite = null;
      ...
      private static function _checkOverlap(param1:Animation, param2:Number, param3:Boolean) : Number
      {
         ...
         return _loc6_ > param2?Number(_loc6_ - param2):param3 && _loc6_ == param2 || !param1._initted && _loc6_ - param2 < 2 * _loc7_?Number(_loc7_):(_loc6_ = Number(_loc6_ + param1.totalDuration() / param1._timeScale / _loc5_)) > param2 + _loc7_?Number(0):Number(_loc6_ - param2 - _loc7_);
      }
      ...
      protected function _init() : void
      {
         ...
         if(vars.startAt)
         {
            ...
            this._startAt = new com.greensock.TweenLite(this.target,0,vars.startAt);
            if(_loc1_)
            {
               if(_time > 0)
               {
         ...
         else if(vars.runBackwards && _duration !== 0)
         {
            ...
            else
            {
               ...
               this._startAt = com.greensock.TweenLite.to(this.target,0,_loc6_);
               if(!_loc1_)
               {
                  this._startAt.render(-1,true);
               }
      ...
      protected function _initProps(param1:Object, param2:Object, param3:Array, param4:Object) : Boolean
      {
         ...
         for(_loc6_ in _loc5_)
         {
            ...
            else
            {
               ...
               this._firstPT.c = typeof _loc10_ === "number"?Number(Number(_loc10_) - this._firstPT.s):typeof _loc10_ === "string" && _loc10_.charAt(1) === "="?Number(int(_loc10_.charAt(0) + "1") * Number(_loc10_.substr(2))):Number(Number(_loc10_)) || Number(0);
            }
         }
         if(param4)
         {
