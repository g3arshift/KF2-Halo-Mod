package scaleform.clik.controls
{
   ...
   public class ButtonGroup extends EventDispatcher
   {
      ...
      public function addButton(param1:scaleform.clik.controls.Button) : void
      {
      ...
      public function removeButton(param1:scaleform.clik.controls.Button) : void
      {
      ...
      public function getButtonAt(param1:int) : scaleform.clik.controls.Button
      {
         return this._children[param1] as scaleform.clik.controls.Button;
      }
      
      public function setSelectedButtonByIndex(param1:uint, param2:Boolean = true) : Boolean
      {
         var _loc3_:Boolean = false;
         var _loc4_:scaleform.clik.controls.Button = this._children[param1] as scaleform.clik.controls.Button;
         if(_loc4_ != null)
         {
      ...
      protected function updateSelectedButton(param1:scaleform.clik.controls.Button, param2:Boolean = true) : void
      {
         ...
         var _loc4_:scaleform.clik.controls.Button = this.selectedButton;
         if(param2)
         {
      ...
      public function hasButton(param1:scaleform.clik.controls.Button) : Boolean
      {
      ...
      {
         var _loc2_:scaleform.clik.controls.Button = param1.target as scaleform.clik.controls.Button;
         if(_loc2_.selected)
         {
      ...
      {
         this.removeButton(param1.target as scaleform.clik.controls.Button);
      }
   }
}
